...
function navegar(rota) {
    ...
    if (rota === 'home') {
        ...
        content.innerHTML = `
            ...
            <nav class="cards-nav">
                <div class="card"><div class="card-icon"><i class="fa-solid fa-book" style="color: #0f3d36;"></i></div><h3>Panorama Geral</h3><button class="btn-orange" onclick="navegar('geral')">Acessar →</button></div>
                <div class="card"><div class="card-icon"><i class="fa-solid fa-graduation-cap" style="color: #0f3d36;"></i></div><h3>Panorama por Curso</h3><button class="btn-orange" onclick="navegar('curso')">Acessar →</button></div>
                <div class="card"><div class="card-icon"><i class="fa-solid fa-people-group" style="color: #0f3d36;"></i></div><h3>Panorama por Turma</h3><button class="btn-orange" onclick="navegar('turma')">Acessar →</button></div>
                <div class="card"><div class="card-icon"><i class="fa-regular fa-circle-user" style="color: #0f3d36;"></i></div><h3>Panorama por Aluno</h3><button class="btn-orange" onclick="navegar('aluno')">Acessar →</button></div>
            </nav>
